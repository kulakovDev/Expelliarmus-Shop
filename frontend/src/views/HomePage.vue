  ...
  <main class="space-y-20">
    ...
    <section class="container mx-auto">
      ...
      <div class="space-y-14">
        <CardSlider :title="'Flash Sales'" :items-to-show="5" :width-between-items="316" additional-classes="gap-11">
          <ProductDiscountCard class="product-card"/>
          <ProductDiscountCard class="product-card"/>
          <ProductDiscountCard class="product-card"/>
          <ProductDiscountCard class="product-card"/>
          <ProductDiscountCard class="product-card"/>
    ...
    <section class="container mx-auto">
      ...
      <div class="space-y-16">
        <CardSlider :title="'Browse By Category'" :items-to-show="7" :width-between-items="224" additional-classes="gap-8">
          <CategoryCard :category-name="'Phone'" :category-icon="'/category-icons/phone.svg'"/>
          <CategoryCard :category-name="'Computer'" :category-icon="'/category-icons/computer.svg'"/>
          <CategoryCard :category-name="'Gaming'" :category-icon="'/category-icons/gaming-pad.svg'"/>
          <CategoryCard :category-name="'Smartwatch'" :category-icon="'/category-icons/smartwatch.svg'"/>
          <CategoryCard :category-name="'Headphones'" :category-icon="'/category-icons/headphones.svg'"/>
          <CategoryCard :category-name="'Camera'" :category-icon="'/category-icons/camera.svg'"/>
          <CategoryCard :category-name="'Clothes'" :category-icon="'/category-icons/clothes.svg'"/>
          <CategoryCard :category-name="'Parfum'" :category-icon="'/category-icons/parfum.svg'"/>
        </CardSlider>
        <div class="h-px bg-gray-300 border-0"></div>
      </div>
    </section>
    ...
    <section class="container mx-auto">
      ...
      <ProductCardSet :title="'Best Selling Products'" :button-name="'View All'">
        <ProductCard/>
        <ProductCard/>
        <ProductCard/>
        <ProductCard/>
