<template>
  <footer class="mt-auto sticky bottom-0 z-10">
    <div
      class="container mx-auto bg-[#CECECE] px-8 pt-5 pb-3 rounded-t-lg shadow-light-mode dark:shadow-dark-mode"
    >
      <nav
      ...
      >
        ...
        <div
          ...
          class="flex-shrink-0 content mb-4 md:mb-0"
        >
        ...
        <button
          @click="toggleContent"
          class="py-2 px-2 dark:bg-[#e7a338] bg-black text-white rounded-full absolute -top-10 -right-5"
        >
          <svg
        ...
        <dark-mode class="absolute -top-10 right-7"></dark-mode>
      </nav>
    </div>
  </footer>
</template>
