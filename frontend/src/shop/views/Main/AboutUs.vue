      ...
      <div class="flex justify-between items-center">
        <div class="flex flex-col gap-y-10 max-w-lg">
          ...
          <div class="flex flex-col space-y-6">
            <p>Launched in 2015, Exclusive is South Asia’s premier online shopping marketplace with an active presence in Bangladesh. Supported by wide range of tailored marketing, data and service solutions, Exclusive has 10,500 sallers and 300 brands and serves 3 millioons customers across the region. </p>
...
export default {
  components: {Guarantee, InfoCard, BreadCrumbs},
  data() {
    return {
      links: [
        {
