<template>
  <div>
    <label for="card-expiration-input" class="mb-2 block text-sm font-medium">Card expiration* </label>
    <div class="relative">
...
export default {
  ...
  mounted() {
    const datepickerElement = document.querySelector('#card-expiration-input');
