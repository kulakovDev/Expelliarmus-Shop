<template>
  <div class="w-272 h-352 flex flex-col gap-4 group">
    <div class="relative overflow-hidden">
      ...
      <button @click="removeFromWishlist" class="w-9 h-9 rounded-full flex items-center justify-center absolute top-3 right-3 bg-white">
...
<!--      <div class="flex gap-3">
      ...
      <!-- Check when product is on discount to apply another view -->
